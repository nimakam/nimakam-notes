...
In industry, identity, or the identity space, sometimes describe the greater space of market activities that have to do with identity systems. The open ended nature of the identity space consists of high level consumer, enterprise, and government segments, as well as sub-segments, such as consumer login, social media profiles, identity verification, access management, etc.

In technology circles, identity either refers to identity systems, or to specific instances of digital identity, representing real world people and entities as part of those systems. The notion of digital identity is closely related to security concepts of digital privacy, trust, verification, etc

When it comes to this word, context is always important.
...
We also identify other people and organizations, based on the identities (self-identities) they have put forward, but also with our own additions and subtractions, including judgments around reputation, intentions and trust level. For example we may now have a lower trust for Experian after hearing about their recent security breaches. We maintain long term connections at various levels of engagement and trust, with those people and organizations we deem worthy of future interaction.

We identify objects and things, somewhat similarly to above, but with possible ownership considerations, and without subjective judgments around direct intention and trust.
...
As mentioned above, context is important. So in my field of work, identity is used to mean 3 distinct but related things. 1. Sometimes it is used to mean the identity space, that is, the market encompassing products and services within consumer, enterprise and government segments. 2. At other times, the word refers to identity systems such as the Facebook identity system for consumers, or Azure Active Directory used by enterprises as their primary employee directory. 3. Identity is also often used to mean a specific digital identity, such as someone's Facebook account and user profile.
